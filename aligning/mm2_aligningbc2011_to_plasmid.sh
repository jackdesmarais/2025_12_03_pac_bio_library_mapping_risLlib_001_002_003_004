#!/bin/bash
#SBATCH --job-name=mm2_bc2011_plasmid_align
#SBATCH --mem=100G
#SBATCH --time=10:00:00
#SBATCH --output=./slurm_output/mm2_bc2011_plasmid_align.%j.stdout
#SBATCH --error=./slurm_output/mm2_bc2011_plasmid_align.%j.stderr
#SBATCH --ntasks=1
...
INPUT_BAM="/grid/kinney/data/desmara/2025_12_03_pac_bio_library_mapping_risLlib_001_002_003_004/hifi_reads/m84223_251126_143521_s2.hifi_reads.bc2011.bam"
