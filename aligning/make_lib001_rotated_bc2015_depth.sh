#!/bin/bash
#SBATCH --job-name=lib001_rotated_bc2015_depth
#SBATCH --mem=100G
...
reads_path=/grid/kinney/data/desmara/2025_12_03_pac_bio_library_mapping_risLlib_001_002_003_004/hifi_reads/m84223_251126_143521_s2.hifi_reads.bc2015.bam
